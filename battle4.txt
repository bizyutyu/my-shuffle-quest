...
<head>
<link rel="stylesheet" type="text/css" href="/penshu4_2020/67190489/ex13/battle.css">
<title>
戦闘画面4
</title>
<meta charset="utf-8">
...
if(isset($_POST['myatk'])){
  ...
  //$enehp = 40;
    ...
    $sql5 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$enehp} where id = 4";
    ...
    @$result = pg_query($sql1);
     ...
     if($myhp <= 0){
         ...
         $sql8 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$tekihp} where id = 4";
         ...
         if($enehp <= 0){
             print "あなたの勝ち\n";
    print "<a href=\"battle5.php\">次の戦闘へ</a>\n";
     $sql3 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id1} where id = 1";
         $sql4 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id2} where id = 2";
         $sql5 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id3} where id = 3";
         $sql6 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id5} where id = 5";
...
print "<li>ATK:".$a[4][2]."</li>";
print "<li>DEF:".$a[4][3]."</li>";
print "</ul>\n";

print "<p><img src=\"/penshu4_2020/67190489/ex13/kurage.jpg\" usemap=\"#gozira1\" alt=\"gozira2\"width=\"200\"height=\"200\"></p>";
print "<map name=\"gozira\">";
print "</map>";
...
print "<form action=\"battle4.php\" method=\"post\">\n";
print "<ul class = \"yoko\">\n";
