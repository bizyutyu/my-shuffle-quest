...
<head>
<link rel="stylesheet" type="text/css" href="/penshu4_2020/67190302/ex13/battle.css">
<title>
戦闘画面3
</title>
<meta charset="utf-8">
...
if(isset($_POST['myatk'])){
  ...
  //$enehp = 40;
    ...
    $sql4 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$enehp} where id = 3";
    ...
    @$result = pg_query($sql1);
     ...
     if($myhp <= 0){
         ...
         $sql8 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$tekihp} where id = 3";
         ...
         if($enehp <= 0){
             print "あなたの勝ち\n";
    print "<a href=\"battle4.php\">次の戦闘へ</a>\n";
     $sql3 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id1} where id = 1";
         $sql4 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id2} where id = 2";
         $sql5 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id4} where id = 4";
         $sql6 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id5} where id = 5";
...
print "<li>ATK:".$a[3][2]."</li>";
print "<li>DEF:".$a[3][3]."</li>";
print "</ul>\n";

print "<p><img src=\"/penshu4_2020/67190302/ex13/original.png\" usemap=\"#jin\" alt=\"jin\"width=\"140\"height=\"200\"></p>";
print "<map name=\"jin\">";
print "</map>";
...
print "<form action=\"battle3.php\" method=\"post\">\n";
print "<ul class = \"yoko\">\n";
