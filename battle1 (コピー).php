...
print "<ul class = \"yoko\">\n";
print "<li><input type=\"radio\" name =\"myatk\" value=\"{$a[0][1]}\" checked>戦う</li>";
print "<li><input type=\"radio\" name =\"myatk\" value=\"{$a[0][1]}\" >ファイヤー</li>";
print "<li><input type=\"radio\" name =\"myatk\" value=\"{$a[0][1]}\" >ブリザード</li>";
print "<li><input type=\"radio\" name =\"myatk\" value=\"{$a[0][1]}\" >ウィンド</li>";
print "<li><input type=\"radio\" name =\"myatk\" value=\"{$a[0][1]}\" >クエイク</li>";
print "</ul>\n";
