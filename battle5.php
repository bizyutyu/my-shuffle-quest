...
<head>
<link rel="stylesheet" type="text/css" href="/penshu4_2020/67190285/ex13/battle2.css">
<title>
戦闘画面5
</title>
<meta charset="utf-8">
...
if(isset($_POST['myatk'])){
  ...
  //$enehp = 40;
    ...
    $sql6 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$enehp} where id = 5";
    ...
    @$result = pg_query($sql1);
     ...
     if($myhp <= 0){
         ...
         $sql4 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id2} where id = 2";
         $sql5 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id3} where id = 3";
         $sql6 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$id4} where id = 4";
         $sql7 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$mikatahp} where id = 0";
         $sql8 = "update {$_SERVER['PHP_AUTH_USER']} set hplog = {$tekihp} where id = 5";
...
print "<li>ATK:".$a[5][2]."</li>";
print "<li>DEF:".$a[5][3]."</li>";
print "</ul>\n";

print "<p><img src=\"/penshu4_2020/67190223/ex15/dio.jpeg\" usemap=\"#dio\" alt=\"dio\"width=\"270\"height=\"200\"></p>";
print "<map name=\"surachan\">";
print "</map>";
...
print "<form action=\"battle5.php\" method=\"post\">\n";
print "<ul class = \"yoko\">\n";
